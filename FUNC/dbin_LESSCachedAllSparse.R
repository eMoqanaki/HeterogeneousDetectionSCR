...
#### 1.Density function ####
dbin_LESSCachedAllSparse <- nimbleFunction(run = function( x = double(1)
                                                           , pZero = double(0)
                                                           , sxy = double(1)
                                                           , sigma = double(0)
...
registerDistributions(list(
   dbin_LESSCachedAllSparse = list(
      BUGSdist = "dbin_LESSCachedAllSparse(pZero, sxy, sigma, nbDetections, yDets, 
